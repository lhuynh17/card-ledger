(function () {
  ...
  function install() {
    ...
    style.textContent = `
      ...
      .debt-card{grid-column:1/-1;padding:14px}.debt-card>p{margin-bottom:9px;line-height:1.3}.debt-layout{display:grid;grid-template-columns:minmax(250px,.75fr) minmax(350px,1.25fr);gap:9px}.debt-form{padding:10px;border:1px solid var(--line);border-radius:10px;background:var(--surface-2)}.debt-form .tool-fields{gap:7px}.debt-form .tool-field{grid-template-rows:minmax(20px,auto) auto;gap:3px}.debt-form .tool-field label{min-height:20px}.debt-form .tool-field input,.debt-form .tool-field select{min-height:38px;padding:7px 8px}.debt-form .tool-field textarea{min-height:48px;padding:7px 8px}.debt-form .capital-save{width:100%;min-height:38px;margin-top:7px}.debt-date-amount{grid-column:1/-1;display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:7px}
      .debt-columns{display:grid;grid-template-columns:1fr 1fr;gap:7px}.debt-list{display:grid;gap:6px}.debt-column{padding:10px;border:1px solid var(--line);border-radius:10px;background:var(--surface-2)}.debt-column h3{display:flex;justify-content:space-between;gap:8px;margin:0 0 7px;font-size:13px}.debt-column h3 span{font-family:var(--font-mono)}
