(function () {
  ...
  function install() {
    ...
    style.textContent = `
      ...
      .grading-new{position:relative;padding:17px;border:1px solid var(--outline);border-radius:13px;background:linear-gradient(145deg,var(--surface),var(--surface-end));box-shadow:0 10px 28px rgba(0,0,0,.16);overflow:hidden}.grading-new::before{content:"";position:absolute;inset:0 auto 0 0;width:3px;background:#35b37e}.grading-form{display:grid;grid-template-columns:minmax(180px,2fr) repeat(3,minmax(120px,1fr));align-items:start;gap:7px}.grading-field{display:grid;min-width:0;grid-template-rows:minmax(24px,auto) auto;align-content:start;gap:3px}.grading-field.full{grid-column:1/-1}.grading-field label{display:flex;min-height:24px;align-items:flex-end;font-size:11px;line-height:1.15;color:var(--muted);font-weight:750}.grading-field input,.grading-field textarea{box-sizing:border-box;width:100%;min-height:42px;border:1px solid var(--line);border-radius:9px;background:var(--surface-2);color:var(--text);padding:9px;font:inherit}.grading-field textarea{min-height:62px;resize:vertical}
      .grading-photo-line{grid-column:1/-1;display:flex;align-items:center;gap:9px;min-width:0}.grading-photo-preview{width:72px;height:72px;display:grid;place-items:center;flex:0 0 auto;overflow:hidden;border:1px dashed var(--outline);border-radius:10px;background:var(--surface-2);color:var(--muted);font-size:10px;text-align:center}.grading-photo-preview img{width:100%;height:100%;object-fit:cover}.grading-photo-controls{display:flex;flex-wrap:wrap;align-items:center;gap:6px}.grading-photo-input{position:absolute;width:1px;height:1px;opacity:0;pointer-events:none}
