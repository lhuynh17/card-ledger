(function () {
  ...
  function install() {
    ...
    section.innerHTML = `
      <div class="grading-head"><h2>Grading plays</h2><p>Build a multi-card submission, record grading results, and follow each card through its sales.</p></div>
