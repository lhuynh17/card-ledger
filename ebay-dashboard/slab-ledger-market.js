(function () {
  ...
  function installUi() {
    ...
    style.textContent = `
      ...
      .manual-comps{display:grid;grid-template-columns:repeat(2,1fr);gap:11px;margin-top:18px}.market-help{grid-column:1/-1;margin:0;color:#52675a;font-size:12px}.comp-row{grid-column:1/-1;display:grid;grid-template-columns:140px 1fr;gap:11px;padding:11px;border:1px solid #e1e7e2;border-radius:11px;background:#fafbfa}.mf{display:grid;gap:5px}.mf.full{grid-column:1/-1}.mf label{font-size:11px;font-weight:750;color:#536159}
