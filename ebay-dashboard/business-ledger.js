(function () {
  ...
  function install() {
    ...
    style.textContent = `
      ...
      .finance-band{display:flex;align-items:center;gap:12px;margin:24px 0 12px;padding:0 2px 11px;border-bottom:1px solid var(--line)}.finance-band.first{margin-top:18px}.finance-band span{display:grid;place-items:center;width:31px;height:31px;flex:0 0 auto;border-radius:9px;background:var(--accent-soft);color:var(--accent-readable);font:800 11px var(--font-mono)}.finance-band h2{margin:0;font:650 17px var(--font-display);letter-spacing:.05em;text-transform:uppercase}.finance-band p{margin:2px 0 0;color:var(--muted);font-size:11px}
      ...
      .finance-cards{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:9px}.finance-card{position:relative;padding:14px;border:1px solid var(--outline);border-radius:11px;background:linear-gradient(145deg,var(--surface-2),var(--surface-end));overflow:hidden}.finance-card::before{content:"";position:absolute;inset:0 auto 0 0;width:3px;background:#4b7be5}.finance-card:nth-child(1)::before{background:#35b37e}.finance-card:nth-child(2)::before{background:#e9b949}.finance-card:nth-child(3)::before{background:#ff7885}.finance-card:nth-child(4)::before{background:#9b7bea}
      ...
      .ledger-layout{display:grid;grid-template-columns:minmax(0,.75fr) minmax(0,1.25fr);gap:14px}.ledger-box{max-width:100%;padding:16px;border:1px solid var(--outline);border-top:3px solid #4b7be5;border-radius:12px;background:linear-gradient(145deg,var(--surface),var(--surface-end));box-shadow:0 10px 28px rgba(0,0,0,.14);overflow:hidden}.ledger-box:nth-child(2){border-top-color:#35b37e}
      ...
      .ledger-box:first-child{padding:13px}.ledger-box:first-child h3{margin-bottom:8px}.ledger-box:first-child .ledger-form{gap:7px}.ledger-box:first-child .field-pair{gap:7px}.ledger-box:first-child .ledger-field{grid-template-rows:minmax(20px,auto) auto;gap:3px}.ledger-box:first-child .ledger-field label{min-height:20px;font-size:10px}.ledger-box:first-child .ledger-form input,.ledger-box:first-child .ledger-form select{min-height:38px;padding:7px 8px}.ledger-box:first-child .ledger-form textarea{min-height:48px;padding:7px 8px}.ledger-box:first-child .ledger-actions button{min-height:38px;padding:7px 10px}
      ...
      .exception-box{margin-top:0;padding:16px;border-color:var(--outline);border-top:3px solid #e9b949;background:linear-gradient(145deg,var(--surface),rgba(35,28,12,.22));box-shadow:0 10px 28px rgba(0,0,0,.14)}
